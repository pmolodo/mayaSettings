...
class rockingTransformNode(OpenMayaMPx.MPxTransform):
	...
	def validateAndSetValue(self, plug, handle, context):
		print "in validate for plug: %s" % plug.name()
		if not plug.isNull():
...
#		print kTrackingDictionary[OpenMayaMPx.asHashable(baseXform)] == self.transformationMatrix()
